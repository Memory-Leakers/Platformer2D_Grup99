...
bool Window::PreUpdate()
{
	...
	{
		app->scene->menuScene->cbx1->active = true;
...
bool Window::SaveSettings(pugi::xml_node& config)
{
	
	config.child("fullscreen_window").attribute("value") = app->scene->menuScene->cbx1->active;
